...
VOID MenuAndDestroy(ImGuiWindow& window) {
	...
	if (ShowMenu) {
		...
		if (ImGui::Begin(std::string(std::string(xorstr("fixed by izvestno/tappinecek"))).c_str(), 0, ImGuiWindowFlags_::ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_::ImGuiWindowFlags_NoResize)) {
